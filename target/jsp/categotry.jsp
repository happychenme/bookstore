...
<body>
        <div class="container">
            <div class="head">
                <a style="float: left;font-size: 28px;font-family: '微软雅黑';">分类管理</a>
                <a href="/jsp/toupdatecategory.do" class="btn btn-info" role="button" style="float: right;margin-top: 20px;">添加分类</a>
            </div>
            <div class="input-group mb-3" style="margin-top: 20px;margin-left: 15%;">
                <form class="form-inline" style="width: 60%;" action="/jsp/findCategoryByName.do">
                    <input class="form-control" name="name" type="text" placeholder="输入分类名称" style="width: 45%">
...
<script>
    ...
    $("#table").on("click",".delete",function(){
        ...
        $.ajax({
            type:"post",
            url:"/jsp/deleteCategory.do?id="+id,
            async:true,
...
//感觉自己在瞎弄瞎弄
    $("#table").on("click",".update",function(){
        ...
        $.ajax({
            type:"post",
            url:"/jsp/toupdatecategory.do?name="+name,
            async:true,
            success:function(){
                window.location.href="/jsp/toupdatecategory.do?name="+name;
            }
        });
    })
